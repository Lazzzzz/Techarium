...
public class PoweredFurnaceRenderer extends GeoBlockRenderer<PoweredFurnaceTile> {
	
	public PoweredFurnaceRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn, new PoweredFurnaceModel());
	}

	@Override
	public RenderType getRenderType(PoweredFurnaceTile animatable, float partialTicks, MatrixStack stack,
